...
- **He's alive** — his eyes follow your mouse around the screen, he has spontaneous idle quirks (a little wave, a side-step, blowing a bubble), a sweat drop when a task runs long, a nap when nothing happens. Swipe to another Space and he rides off with the old screen, then materializes on the new one out of a little magic cloud — *poof*. On first launch he introduces himself.
